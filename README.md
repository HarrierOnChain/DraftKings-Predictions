# DraftKings Predictions Trading Bot
...
[![CI](https://github.com/HarrierOnChain/DraftKings-Predictions/actions/workflows/ci.yml/badge.svg)](https://github.com/HarrierOnChain/DraftKings-Predictions/actions/workflows/ci.yml)
...
## Strategies on DraftKings Predictions

These bots run on DraftKings Predictions through a single venue adapter on the shared engine — same risk controls, same TUI, full dry-run support.
...
This repo is the **DraftKings Predictions** entry point. The execution core, risk layer, and all 20+ venue adapters live in the main toolkit:
...
[Azuro](https://github.com/HarrierOnChain/Azuro) · [Better Fan](https://github.com/HarrierOnChain/Better-Fan) · [Fanatics Markets](https://github.com/HarrierOnChain/Fanatics-Markets) · [FanDuel Predicts](https://github.com/HarrierOnChain/FanDuel-Predicts)
...
> Trading prediction markets involves real financial risk. This software is provided as-is, without warranty. It is not financial advice. Always test with `enable_trading: false` before deploying real capital. Ensure compliance with DraftKings Predictions's terms of service and your local regulations.

---

<div align="center">

**DraftKings Predictions trading bot · built on the [Prediction Market Toolkits](https://github.com/HarrierOnChain/Prediction-Markets-Trading-Bot-Toolkits) engine**
